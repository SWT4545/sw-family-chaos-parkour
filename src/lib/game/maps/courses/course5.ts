...
const VOLCANO_ESCAPE: MapDef = {
  ...
  soloHazards: [
    { x: 380,  y: 560, type: 'spike' },
    { x: 660,  y: 510, type: 'spike' },
    { x: 810,  y: 460, type: 'spike' },
    { x: 1070, y: 360, type: 'spike' },
    { x: 1420, y: 310, type: 'spike' },
    { x: 1750, y: 300, type: 'spike' },
    { x: 2170, y: 260, type: 'spike' },
    { x: 2480, y: 260, type: 'spike' },
    { x: 2760, y: 260, type: 'spike' },
    { x: 3050, y: 220, type: 'spike' },
  ],
}
